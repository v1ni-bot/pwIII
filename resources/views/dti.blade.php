...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <form method="get">
        <select id="local_m_dti" name="local_manu_dti">
            <option disabled selected>Selecione o Local</option>
            <option value="admin">Administração</option>
            <option value="biblio">Biblioteca</option>
            <option value="anexo">Anexo</option>
            <option value="B_A">Bloco A</option>
            <option value="B_B">Bloco B</option>
            <option value="B_C">Bloco C</option>
            <option value="outro">Outros</option>
        </select>
        <br>
        <select id="prioridade" name="prio_manu_dti">
        ...
        <br>
        <select id="m_dti" name="manu_dti">
            <option disabled selected>Selecione Setor</option>
            <option value="comp">Computador</option>
            <option value="monit">Monitor</option>
            <option value="perif">Periféricos</option>
            <option value="som">Som</option>
            <option value="tv">Televisão</option>
            <option value="proj">Projetor</option>
            <option value="rede">Rede</option>
            <option value="outro">Outros</option>
        </select>
        <br>
        <input id="description" type="text" placeholder="De uma descrição">
        <br>
