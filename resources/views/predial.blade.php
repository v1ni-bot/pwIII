...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <form method="get">
        <select id="m_p" name="manu_predial">
            <option disabled selected>Selecione a Manutenção</option>
            <option value="hidro">Hidráulica</option>
            <option value="eletro">Elétrica</option>
            <option value="Estr">Estrutura</option>
            <option value="Limp">Limpeza</option>
        </select>
        <br>
        <select id="local_m_p" name="local_manu_predial">
